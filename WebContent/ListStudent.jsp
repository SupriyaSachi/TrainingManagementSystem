...
<%String message = (String)request.getAttribute("ErrorMessage"); 
	...
	<% }
	%>
<form action="ListStudentAction" method="post">
...
<br>
    <table border="1">
       ...
       <input type="submit" name="action" value="Go To Previous Page"/> <input type="submit" name="action" value="Add Another Course"/> 
