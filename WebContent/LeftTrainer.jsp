...
function isValidRelievingDate()
{
	var input = document.RegisterTrainer.DateOfRelieving;
	
    if (input.value.length == 0)
    {
    	document.getElementById('Dor').style.borderColor = "red";
    	document.getElementById("error").innerHTML = "Please Enter The Date Of Relieving!!";
    	return false;
    }
    else
    {
    	document.getElementById('Dor').style.borderColor = "#c7d0d2";
    	document.getElementById("error").innerHTML = " ";
    	return true;
    }	
}
...
<%String message = (String)request.getAttribute("ErrorMessage"); 
	...
	<% }
	%>
<form name="RegisterTrainer" action="LeftTrainerAction" method="post" onsubmit="return formValidation()">
...
<td><label for="value" >Relieving Date: </label></td>
<td><input type="date" name="DateOfRelieving" id="Dor" onkeyup="isValidRelievingDate()"></td>
</tr>
