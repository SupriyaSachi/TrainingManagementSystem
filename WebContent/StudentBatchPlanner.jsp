...
function formValidation()   
{
	...
	{
		 var message = "Are you sure you want to navigate away from this page?\n\nYou have started writing or editing a student batch planner form.\n\nPress OK to continue or Cancel to stay on the current page.";
		 if (confirm(message)) 
        	 return true;
         else 
        	 return false;
...
{   
   ...
   {  
	   ...
	   document.getElementById("error").innerHTML = "Please Select Batch Status as Ongoing";
	   return false;  
   }  
}
...
<%String message = (String)request.getAttribute("ErrorMessage"); 
	...
	<form name="RegisterStudent" action="StudentBatchPlannerAction" method="post" onsubmit="return formValidation()">
...
<td><label for="TrainerId">     Trainer Id:</label></td>
  ...
  <label for="h2">Batch Details:-</label><br>
    ...
    <%    ArrayList<Batch> Batchlist = student.getBatchlist(); %>
      ...
      <br>
       ...
       <label for="h2"> Trainer Details:- </label><br>
