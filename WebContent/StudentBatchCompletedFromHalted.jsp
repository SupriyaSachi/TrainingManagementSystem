...
function formValidation()   
{
	...
	{
		 var message = "Are you sure you want to navigate away from this page?\n\nYou have started writing or editing a student batch allocated form.\n\nPress OK to continue or Cancel to stay on the current page.";
		 if (confirm(message)) 
        	 return true;
         else 
        	 return false;
...
{   
   ...
   var r = document.getElementsByName("BatchStatus")
   var c = -1
...
{    
	var tfname = document.RegisterStudent.TrainerFirstName;	
   var letters = /^[A-Za-z]+$/; 
...
{    
	var tlname = document.RegisterStudent.TrainerLastName;	
   var letters = /^[A-Za-z]+$/;   
...
{
	var Status = document.RegisterStudent.TrainerStatus;
	   if(Status.value == "Free" || Status.value == "Occupied")   
	   {   
...
<%String message = (String)request.getAttribute("ErrorMessage"); 
	...
	<% }%>	
<form name="RegisterStudent" action="StudentBatchCompletedFromHaltedAction" method="post" onsubmit="return formValidation()">
...
<td>
               ...
               <label for="Status"><input type="radio" name="BatchStatus" value="NotStarted" onkeyup="validbatchstatus()"> NotStarted</label>
           
             
               <label for="Status"><input type="radio" name="BatchStatus" value="Ongoing" onkeyup="validbatchstatus()"> Ongoing </label>
             
          		<label for="Status"><input type="radio" name="BatchStatus" value="Halt" onkeyup="validbatchstatus()"> Halt </label>
        	
     	
       		 <label for="Status"><input type="radio" name="BatchStatus" value="Completed" checked="checked" onkeyup="validbatchstatus()"> Completed </label>
...
<td><input type="text" name="TrainerId" value="<%= student.trainer.getTrainerId() %>" id="Tid" onkeyup="trainerid_validation()"></td>
           
<td><label for="TrainerFirstName">Trainer First Name: </label></td>
<td><input type="text" name="TrainerFirstName" value="<%= student.trainer.getTrainerFirstName() %>" id="firstname" onkeyup="trainerfirstnameallLetter()"></td>
           
<td><label for="TrainerLastName"> Trainer Last Name: </label></td>
<td><input type="text" name="TrainerLastName" value="<%= student.trainer.getTrainerLastName() %>" id="lastname" onkeyup="trainerlastnameallLetter()"></td>
</tr>    
     
<tr>           
<td><label for="Availability"> Trainer Availability: </label></td>
<td>
           <% if(student.trainer.getAvailability().equals("Fulltime")) 
           {%>
            ...
            {%>
             ...
             <% } 
		if(student.trainer.getAvailability().equals("Parttime")) 
        {%>
 ...
 <td><label for="TrainerStatus">Trainer Status: </label></td>
 <td><label for="Free"><select name="TrainerStatus" id="status" onkeyup="validstatus()">
           <% if(student.trainer.getTrainerStatus().equals("Free")) 
           {%>
            ...
            {%>
             ...
             <% } 
           	if(student.trainer.getTrainerStatus().equals("Occupied")) 
           {%>
