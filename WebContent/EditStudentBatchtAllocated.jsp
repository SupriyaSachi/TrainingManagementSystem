...
{   
   ...
   {   
	   document.getElementById('bstatus').style.borderColor = "#c7d0d2";
	   document.getElementById("error").innerHTML = " ";
	   return true;  
   }   
   else  
   {  
	   document.getElementById('bstatus').style.borderColor = "red";
...
<form name="RegisterStudent" action="EditBatchAllocatedStudentListAction" method="post" onsubmit="return formValidation()">
...
<td><label for="BatchStatus">Batch Status: </label></td>
 <td><label for="value" >     
            <select name="BatchStatus" id="bstatus" onkeyup="validbatchstatus()">
