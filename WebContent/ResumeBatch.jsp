...
function formValidation()   
{
	...
	{
		 var message = "Are you sure you want to navigate away from this page?\n\nYou have started writing or editing a Resume Batch form.\n\nPress OK to continue or Cancel to stay on the current page.";
		 if (confirm(message)) 
        	 return true;
         else 
        	 return false;
...
{   
   ...
   {   
	   ...
	   document.getElementById("error").innerHTML = "Please Resume Batch from Halt Batch Status";
	   return false;  
   }   
   else  
   {  
...
<form name="BatchPlan" action="ResumeBatchAction" method="post" onsubmit="return formValidation()">
...
<tr>
<td><label for="BatchEndDate">Trainer ID:</label></td>
