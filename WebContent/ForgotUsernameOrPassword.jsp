...
{    
	var sfname = document.ForgotUsernameOrPasswordAction.UserFirstName;	
   var letters = /^[A-Za-z]+$/; 
...
{    
	var slname = document.ForgotUsernameOrPasswordAction.UserLastName;	
   var letters = /^[A-Za-z]+$/;   
...
{    
	...
	var uicno = document.ForgotUsernameOrPasswordAction.UserICNo;	
...
{      
	var fld = document.ForgotUsernameOrPasswordAction.UserName;
...
{      
	var fld = document.ForgotUsernameOrPasswordAction.Passwd;
	var illegalChars = /\W/; // allow letters, numbers, and underscores     
	if (fld.value == "") 
	{        
...
{      
	var pass = document.ForgotUsernameOrPasswordAction.Passwd;
	var pass1 = document.ForgotUsernameOrPasswordAction.repasswd;
	var illegalChars = /\W/; // allow letters, numbers, and underscores     
	if (pass1.value == "") 
	{        
...
<%String message = (String)request.getAttribute("ErrorMessage"); 
	...
	<% } %>
<form name="ForgotUsernameOrPasswordAction" action="ForgotUsernameOrPasswordAction" method="post" onsubmit="return formValidation()">
