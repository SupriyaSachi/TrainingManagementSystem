...
function formValidation()   
{
	...
	{
		 var message = "Are you sure you want to navigate away from this page?\n\nYou have started writing or editing a student batch not allocated form.\n\nPress OK to continue or Cancel to stay on the current page.";
		 if (confirm(message)) 
        	 return true;
         else 
        	 return false;
...
<%String message = (String)request.getAttribute("ErrorMessage"); 
	...
	<% }
	%>
<form name="RegisterStudent" action="EditStudentBatchNotAllocatedListAction" method="post" onsubmit="return formValidation()">
