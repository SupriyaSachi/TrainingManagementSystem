...
<form action="BatchCompletedListStudentAction" method="post">
...
<br>
    <table border="1">
       <tr>
          ...
          <th><label for="header">  Trainer Availability   </label></th>
       </tr>
       ...
       <%     String[] CourseConductingOn = student.course.getCourseConductingOn();
       	...
       	<td> <label for="header"> <%= student.batch.getBatchId() %> </label> </td>
         ...
         %>
	    <td> <label for="header"> <%= Startmdy %> </label> </td>   
	    ...
	    <% Date BatchEndDate = student.batch.getBatchEndDate();
         ...
         %>
	    <td> <label for="header"> <%= Endmdy %> </label> </td>	
	    
	    <td> <label for="header"> <%= student.batch.getBatchStatus() %> </label> </td>
	    <td> <label for="header"> <%= student.trainer.getTrainerId() %> </label> </td>
	    <td> <label for="header"> <%= student.trainer.getTrainerFirstName() %> </label> </td>
	    <td> <label for="header"> <%= student.trainer.getTrainerLastName() %> </label> </td>
	    <td> <label for="header"> <%= student.trainer.getAvailability() %> </label> </td>
	    <% } %>
        </tr>
       </table>
       <p align="center">
<input type="submit" name="action" value="Go To Previous Page"/> <input type="submit" name="action" value="Delete"/> 
 </p>
  <% } %> 
