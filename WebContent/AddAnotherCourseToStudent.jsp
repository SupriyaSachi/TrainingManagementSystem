...
function formValidation()   
{
	...
	{
		 var message = "Are you sure you want to navigate away from this page?\n\nYou have started writing or editing a add another course for a student.\n\nPress OK to continue or Cancel to stay on the current page.";
		 if (confirm(message)) 
        	 return true;
         else 
        	 return false;
...
<%String message = (String)request.getAttribute("ErrorMessage"); 
	...
	<% }
	%>
	<form name="RegisterStudent" action="AddAnotherCourseToStudentAction" method="post" onsubmit="return formValidation()">
...
<td> <input type="text" name="StudentId" value="<%= student.getStudentId() %>" id="studid" onkeyup="studentid_validation()">
</td>
...
<td>
	<% if(student.getGender().equals("Male")) 
           {%>
<label for="Male">   <input type="radio" name="Gender" value="Male" checked="checked"> Male  </label>
            <%} 
            else 
            {%>
    <label for="Male"> <input type="radio" name="Gender" value="Male" id="sex" onkeyup="validsex()"> Male </label>
             <% } 
	
	
		if(student.getGender().equals("Female")) 
       {%>
    <label for="Female">  <input type="radio" name="Gender" value="Female" checked="checked"> Female </label>
     	<%} 
     	else 
    	 {%>
...
<td><label for="value" >	<select name="CourseName" id="coursetitle" onkeyup="courseselect()">
	...
	<td><input type="date" name="PrefCourseStartDate" id="prefsd" onkeyup="isValidStartDate()">  </td>  
	
	 
	<td><label for="PrefCourseEndDate">Preferable Course End Date:</label></td>
	<td><input type="date" name="PrefCourseEndDate" id="prefed" onkeyup="isValidEndDate()">    </td>
	</tr>
	...
	<label for="No"><input type="radio" name="BatchAllocationStatus" value="No"> No </label> </td>
	
	</tr>
	
	<tr>
<td><label for="Findaboutus">	How did you find about us:</label>	</td>
<td><label for="value" >	<select name="Findaboutus" id="find" onkeyup="findaboutus()">
