...
<%@page import="trainingplan.course.domain.Trainer" %><html>
<head>
...
<form action="BatchHaltedStudentListAction" method="post">
...
<br><br>
    <table border="1">
       ...
       <p align="center">
<input type="submit" name="action" value="Go To Previous Page"/> <input type="submit" name="action" value="Delete"/> <input type="submit" name="action" value="Resume Batch"/> <input type="submit" name="action" value="Edit"/>   
 </p>
 <%} %>
 </form>
