...
/**
 * Servlet implementation class CreateNewUserAndPasswordAction
 */
@WebServlet("/CreateNewUserAndPasswordAction")
public class CreateNewUserAndPasswordAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateNewUserAndPasswordAction() {
        super();
		...
		if (request.getParameter("action").equals("Save"))
		{
				...
				Passwd != null	&&  Password != null)
			{
				...
				if (Passwd.equals(Password))
				{
					...
					{
						request.setAttribute("ErrorMessage", "User Account already exist !!!");
						RequestDispatcher rd = request.getRequestDispatcher("CreateNewUserAndPassword.jsp");
						rd.forward(request, response);
					}
					else
					{
						...
						loginandpassDAO.save(loginandpass);
