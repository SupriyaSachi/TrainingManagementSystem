...
/**
 * Servlet implementation class BatchCompletedStudentListAction
 */
@WebServlet("/BatchCompletedStudentListAction")
public class BatchCompletedStudentListAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BatchCompletedStudentListAction() {
        super();
