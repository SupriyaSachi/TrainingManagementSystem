...
/**
 * Servlet implementation class EditBatchAllocatedStudentListAction
 */
@WebServlet("/EditBatchAllocatedStudentListAction")
public class EditBatchAllocatedStudentListAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditBatchAllocatedStudentListAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("action").equals("Save"))
		{
			...
			{				
					...
					if ((BatchStatus.equals("Completed")) || (BatchStatus.equals("Halt")))
					{
						trainer = new Trainer(TrainerId, "Free"); 
						
					}
					else if (BatchStatus.equals("Ongoing")) 
					{
					...
					RequestDispatcher rd = request.getRequestDispatcher("BatchAllocatedStudentList.jsp");  /*Batch not allocated Student list*/
			...
			else if (StudentId != null)
			{
				...
				RequestDispatcher rd = request.getRequestDispatcher("EditStudentBatchtAllocated.jsp");
				rd.forward(request, response);
			}
	}
