...
/**
 * Servlet implementation class EditBatchAction
 */
@WebServlet("/EditBatchAction")
public class EditBatchAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditBatchAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//	String selected = request.getParameter("selected");
			...
			/*	if (BatchStatus.equals("Completed"))
				...
				if (BatchStatus.equals("Halt") || BatchStatus.equals("Completed"))
				{
