...
/**
 * Servlet implementation class ListCourseOptionsAction
 */
@WebServlet("/ListCourseOptionsAction")
public class ListCourseOptionsAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListCourseOptionsAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		if ((request.getParameter("action")).equals("Plan Course"))
		{
			RequestDispatcher rd = request.getRequestDispatcher("PlanCourse.jsp");
			rd.forward(request, response);
		}
		else if ((request.getParameter("action")).equals("List Course"))
		{
