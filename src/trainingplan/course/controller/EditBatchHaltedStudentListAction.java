...
/**
 * Servlet implementation class EditBatchHaltedStudentListAction
 */
@WebServlet("/EditBatchHaltedStudentListAction")
public class EditBatchHaltedStudentListAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditBatchHaltedStudentListAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("action").equals("Save"))
		{
			...
			if(StudentId != null && StudentFirstName != null && StudentLastName != null &&
			   ...
			   BatchAllocationStatus != null && BatchId != null && BatchStatus != null)
			{				
